<?php
    ...
    $results = mysqli_query($con, "SELECT * FROM multimoora_4");
?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="../bobot/result.php">Nilai Terbobot</a>
                                <a class="dropdown-item" href="result.php">Perankingan</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
