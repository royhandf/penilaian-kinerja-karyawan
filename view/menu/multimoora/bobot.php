...
$results = mysqli_query($con, "SELECT * FROM multimoora_3");
?>
            ...
            <div class="collapse navbar-collapse" id="DataDropdown">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="../pra-normalisasi/result.php">Pra-Normalisasi</a>
                                <a class="dropdown-item" href="../normalisasi/result.php">Normalisasi</a>
                                <a class="dropdown-item" href="result.php">Nilai Terbobot</a>
                                <a class="dropdown-item" href="../ranking/result.php">Perankingan</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="/si-penilaian-kerja/index.php?method=mutlimoora">Multimoora</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= round($result['pra'], 3); ?></td>
                    <td><?= round($result['normalisasi'], 3); ?></td>
                    <td><?= round($result['normalisasibobot'], 5); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
