...
$results = mysqli_query($con, "SELECT * FROM topsis_maxmin");
?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="result.php">Nilai Max & Min</a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= round($result['max'], 3); ?></td>
                    <td><?= round($result['min'], 3); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
