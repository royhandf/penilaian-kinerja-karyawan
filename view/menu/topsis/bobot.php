...
$results = mysqli_query($con, "SELECT * FROM topsis_terbobot");
?>
...
<body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="result.php">Terbobot</a>
                                <a class="dropdown-item" href="../maxmin/result.php">Nilai Max & Min</a>
                                <a class="dropdown-item" href="../maxmin/result.php">Nilai V</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <main class="container mt-5 py-4">
        <h3 class="mb-3">Data Nilai Terbobot</h3>
        <table class="table">
