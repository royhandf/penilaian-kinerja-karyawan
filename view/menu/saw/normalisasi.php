<?php
    ...
    $results = mysqli_query($con, "SELECT * FROM vnormalisasi");
?>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Data Normalisasi</h1>
                </div>
                    ...
                    <table class="table table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="5%"><?= $result['value']; ?></td>
                                <td width="5%"><?= $result['nilai']; ?></td>
                                <td width="10%"><?= $result['nama_skala']; ?></td>
                                <td width="10%"><?= $result['normalisasi']; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
