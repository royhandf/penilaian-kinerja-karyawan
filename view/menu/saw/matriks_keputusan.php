<?php
    ...
    $results = mysqli_query($con, "SELECT * FROM vmatriks_keputusan ORDER BY id_matriks ASC");
?>
        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a class="nav-link " href="../../data/dtkriteria.php">
                                <span data-feather="file-text"></span> Kriteria
                            </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="../../data/dtalternatif.php">
                                <span data-feather="file-text"></span> Alternatif
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../../data/dtbobot.php">
                                <span data-feather="file-text"></span> Bobot
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../../data/dtskala.php">
                                <span data-feather="file-text"></span> Skala
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../data/dtmatrix.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Data Matriks Keputusan</h1>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="5%"><?= $result['id_matriks']; ?></td>
                                <td width="5%"><?= $result['id_alternatif']; ?></td>
                                <td width="10%"><?= $result['nama_alternatif']; ?></td>
                                <td width="10%"><?= $result['id_kriteria']; ?></td>
                                <td width="10%"><?= $result['nama_kriteria']; ?></td>
                                <td width="10%"><?= $result['id_bobot']; ?></td>
                                <td width="10%"><?= $result['value']; ?></td>
                                <td width="10%"><?= $result['nilai']; ?></td>
                                <td width="10%"><?= $result['nama_skala']; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
