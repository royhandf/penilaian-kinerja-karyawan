...
$results = mysqli_query($con, "SELECT * FROM wp_normalisasibobot");
?>
...
<head>
    ...
    <title>Data Normalisasi Bobot</title>
...
<body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="../pangkat/result.php">Pangkat</a>
    ...
    <div class="container mt-5 py-4">
        <h3 class="mb-3">Data Normalisasi Bobot</h3>
        <table class="table">
