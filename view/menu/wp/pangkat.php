...
$results = mysqli_query($con, "SELECT * FROM wp_pangkat");
?>
...
<head>
    ...
    <title>Data Nilai Pangkat</title>
...
<body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a class="dropdown-item" href="result.php">Pangkat</a>
                                <a class="dropdown-item" href="../nilai_s/result.php">Nilai S</a>
    ...
    <div class="container mt-5 py-4">
        <h3 class="mb-3">Data Nilai Pangkat</h3>
        <table class="table">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">Normalisasi WP</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= round($result['normalisasi_wp'], 3); ?></td>
                    <td><?= round($result['pangkat'], 2); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
