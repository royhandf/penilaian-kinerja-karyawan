<?php
    ...
    $results = mysqli_query($con, "SELECT * FROM matriks");
?>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="../form/formmatrix.php" class="btn btn-primary">Tambah</a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="25%"><?= $result['id_matriks']; ?></td>
                                <td width="25%"><?= $result['id_alternatif']; ?></td>
                                <td width="25%"><?= $result['id_bobot']; ?></td>
                                <td width="25%"><?= $result['id_skala']; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
